...
Informações complementares de segurança podem ser consultadas em [https://github.com/OpenBanking-Brasil/specs-seguranca/blob/main/open-banking-brasil-financial-api-1\_ID3-ptbr.md](https://github.com/OpenBanking-Brasil/specs-seguranca/blob/main/open-banking-brasil-financial-api-1_ID3-ptbr.md) .
...
Para garantir a integridade e o não-repúdio das informações tramitadas em _API´s sensíveis e que indicam essa necessidade na sua documentação_, deve ser adotado a estrutura no padrão JWS definida na \[[RFC7515](https://datatracker.ietf.org/doc/html/rfc7515 "https://datatracker.ietf.org/doc/html/rfc7515")\] e que inclui:
...
O payload das mensagens (requisição e resposta _JWT_) assinadas devem incluir as seguintes `claims` presentes na [RFC7519](https://datatracker.ietf.org/doc/html/rfc7519#section-4.1 "https://datatracker.ietf.org/doc/html/rfc7519#section-4.1"):
